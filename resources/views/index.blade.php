...
<section id="section_1" class="floating_box top_section_1 common">
    ...
    <div class="floating_box_right">
        ...
        <p>何かと心配になる美容整形、それも韓国での施術となれば 尚更のことと思います。
           言葉の問題・滞在期間中の問題・アフターケアの問題などなど 様々な不安があるのでは？ 
           私たちMiyong Supportは日本と韓国それぞれに独自スタッフを滞在させており、
           お一人お一人に最適なプランの策定とご説明を 貴女が納得するまで行います。
        </p>
        <p class="text_end">「不安と心配」を解消して「貴女の希望する姿」への<br>サポートをさせてください。</p>
    </div>
</section>
